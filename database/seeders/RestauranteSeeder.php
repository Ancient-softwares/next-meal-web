    ...
    public function run()
    {
        DB::table('tbrestaurante')->insert(
            array(
                ...
                [
                    'nomeRestaurante' => "Cafeteria do Calisto",
                    'cnpjRestaurante' => "12345678901234",
                    'telRestaurante' => "1125555555",
                    'loginRestaurante' => "calistobar",
                    'senhaRestaurante' => password_hash('123', PASSWORD_DEFAULT),
                    'fotoRestaurante' => "user.png",
                    'emailRestaurante' => "calistobar@gmail.com",
                    'cepRestaurante' => "94050010",
                    'ruaRestaurante' => "Rua Jaraguá do Sul",
                    'numRestaurante' => "10",
                    'bairroRestaurante' => "COHAB B",
                    'cidadeRestaurante' => "Valinhos",
                    'estadoRestaurante' => "SP",
                    'capMaximaRestaurante' => 30,
                    'ocupacaoRestaurante' => 0,
                    'idTipoRestaurante' => 17,
                    'horarioAberturaRestaurante' => "12:00:00",
                    'horarioFechamentoRestaurante' => "23:00:00",
                    "descricaoRestaurante" => "Cafeteria do Calisto é um bar de bairro que busca oferecer as melhores bebidas e lanches da região por preços acessíveis.",
                    'created_at' => Date::now(),
                    'updated_at' => Date::now(),
                ],
                [
                    'nomeRestaurante' => "Lanchonete Flor do Campo",
                    'cnpjRestaurante' => "98765432109876",
                    'telRestaurante' => "1123333333",
                    'loginRestaurante' => "flordocampo",
                    'senhaRestaurante' => password_hash('123', PASSWORD_DEFAULT),
                    'fotoRestaurante' => "user.png",
                    'emailRestaurante' => "flordocampo@outlook.net",
                    'cepRestaurante' => "18013270",
                    'ruaRestaurante' => "Rua Martins França",
                    'numRestaurante' => "10",
                    'bairroRestaurante' => "Guaianazes",
                    ...
                    'capMaximaRestaurante' => 40,
                    'ocupacaoRestaurante' => 0,
                    'idTipoRestaurante' => 16,
                    'horarioAberturaRestaurante' => "8:00:00",
                    'horarioFechamentoRestaurante' => "17:00:00",
                    'descricaoRestaurante' => "Lanchonete Flor do Campo é uma lanchonete do povão.",
                    'created_at' => Date::now(),
                    'updated_at' => Date::now(),
                ]
            )
